...
draw_sprite_ext(sprite, 1, x, y, y_scale / scale, 1 / scale, direction_array[12] - 90 + (sway / 1.5), c_white, 1);

draw_sprite_ext(sprite, 0, x, y, y_scale / scale, 1 / scale, image_angle, c_white, 1);


//if in_cam = true {
//draw_sprite_ext(sprite, 3, x, y, y_scale / scale, 1 / scale, image_angle, c_white, 0.3);
//}
